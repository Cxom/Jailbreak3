package me.cxom.jailbreak3.messaging;
...
public class Messaging {
	...
	public static void send(Player player, Message message, Object... arguments) {
		player.sendMessage(Jailbreak.CHAT_PREFIX + message.get(arguments));
	...
	public static void MATCH_STARTING_IN(Player player, int seconds, String arenaName) {
		player.sendMessage(Jailbreak.CHAT_PREFIX + ChatColor.GOLD + "Match starting in " + seconds + " second(s) on " + arenaName + "!");
	}
