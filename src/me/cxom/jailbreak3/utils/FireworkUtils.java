...
public class FireworkUtils {
	...
	public static Firework spawnFirework(Location loc, JailbreakColor color, int power){ return spawnFirework(loc, color.getBukkitColor(), power); }
	...
	public static Firework spawnFirework(Location loc, JailbreakColor primary, JailbreakColor secondary, int power){ return spawnFirework(loc, primary.getBukkitColor(), secondary.getBukkitColor(), power); }
	...
	public static void detontateInstantly(Firework fw){
		...
		}.runTaskLater(Jailbreak.getPlugin(), 1);
	}
